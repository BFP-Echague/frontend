<script>
  import { Navbar, Nav, NavItem, NavLink, Container, Row, Col, Card, CardBody, CardTitle, Form, FormGroup, Label, Input, Button, Alert, Progress } from "@sveltestrap/sveltestrap";
      ...
      <Card class="shadow">
        <CardBody>
          ...
          <div class="d-flex align-items-start gap-3">
            <img src="/incident.jpg" alt="Incident details image" class="rounded" style="width: 450px;" />
            <div>
